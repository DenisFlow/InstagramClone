...
public class SharePictureTab extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imgShare = view.findViewById(R.id.imageViewYourImage);
        edtDescription = view.findViewById(R.id.editTextDescription);
        btnShareImage = view.findViewById(R.id.buttonShareImage);
            ...
            case R.id.buttonShareImage:
                if (receivedImageBitmap != null){
                    if (edtDescription.getText().toString().equals("")){
                        FancyToast.makeText(getContext(), "You must specify the description.", Toast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                    } else {
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if (e == null){
                                    ...
                                    FancyToast.makeText(getContext(), "ERROR", Toast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                                }
